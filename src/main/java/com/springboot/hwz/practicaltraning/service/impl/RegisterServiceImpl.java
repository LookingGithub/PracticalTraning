...
import com.springboot.hwz.practicaltraning.repository.BrowseRepository;
...
//        // 如果没有数据返回true
    ...
    public E3Result register(User user) {
        ...
        // 把用户数据插入到数据库中
        userRepository.save(user);//新增3.18
...
//        }
        ...
        // 执行查询
//        List<User> listName = userRepository.findByUser(user);
//        List<User> listEmail = userRepository.findByUser(user);
//        // 判断结果中是否包含数据
